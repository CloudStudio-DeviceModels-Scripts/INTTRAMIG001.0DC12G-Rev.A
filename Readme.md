...
# Parsing + Configuration Script – INTTRAMIG001.0DC12G - Rev. A

This **Parsing + Configuration** script is designed for the **INTTRAMIG001.0DC12G** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – INTTRAMIG001.0DC12G Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **INTTRAMIG001.0DC12G** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
